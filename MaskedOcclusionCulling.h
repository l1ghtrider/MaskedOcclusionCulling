...
#endif
    bool quickMask = true;
    inline bool GetRealQuickMask() { return mQuickMask; }
#if MOC_DEBUG != 0
    int culled = 0;
    int tested = 0;
#endif
...
protected:
	...
	const int delaySize = 10;
	//int indices[10];
	//int reindices[10];
	int* indices = new int[delaySize];
	int* reindices = new int[delaySize];
#endif
